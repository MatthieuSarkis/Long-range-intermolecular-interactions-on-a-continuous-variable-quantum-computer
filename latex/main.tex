...
\section{Definition of the model}
    ...
    \subsection{One-dimensional case}
        ...
        \end{split}
        \end{equation}
        The model we consider is therefore given by
        \begin{equation}
        \begin{split}
            H=&\ \frac{\hbar\omega_1}{2}\left(P_1^2 + X_1^2\right) + \frac{\hbar\omega_2}{2}\left(P_1^2 + X_1^2\right)\\
        ...
        \begin{equation}
        \begin{split}
            H &= \frac{\hbar\omega_1}{2}\left( a_{1}^\dagger\cdot a_{1} +\frac{3}{2}\right) + \frac{\hbar\omega_2}{2}\left(a_{2}^\dagger\cdot a_{2} +\frac{3}{2}\right) \\
...
\section{Photonic circuit}
    ...
    The circuit is therefore composed of at most quadratic optical components (squeezing operations for our ansatz). However for the other models,  non-Gaussian operation should be added in the end of each layer in the ansatz circuit.
