...
\subsection{Entanglement entropy and position quadratures correlation}
    ...
    \begin{equation}
        \frac{\partial E_\text{Rep}}{\partial d}(d_\star) = -\frac{\partial E_\text{Corr}}{\partial d}(d_\star)\,,
    \end{equation}
    can be interpreted as the transition between a large distance regime in which it is beneficial for the system to increase correlation in order to lower its ground state energy, and a short range regime in which the Coulombe repulsion dominates.
