...
\paragraph*{Binding energy curve}
    ...
    On fig. (\ref{fig:binding}) we observe a perfect agreement with a fit of Morse type \cite{herzberg1950spectra, apanavicius2021morse, le2006accurate, roy2007new}:
    \begin{equation}
    \label{eq:morse_fit}
...
\paragraph*{Ground state wavefunction and entanglement entropy}
    ...
    \label{fig:entropy_correlation}
        %\hspace{1.25cm}
        %\begin{subfigure}
        \includegraphics[scale=0.89]{figures/entropy_correlation.pdf}
        %\end{subfigure}
