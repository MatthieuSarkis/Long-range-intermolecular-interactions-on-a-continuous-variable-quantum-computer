...
\section{Introduction}
    ...
    \label{fig:qdos}
        ...
        %\end{subfigure}
        \caption{Illustration of a system composed of a paire of QDOs. The nuclei are considered to be infinitely massive. The drudons interact with their nucleus through a harmonic potential, but with the other QDO through Coulomb interaction. $\bm x_i$ denote the relative position of the drudon with respect to its nucleus in QDO $i$. $\bm r$ denotes position of QDO 1 with respect to QDO 2.}
    \end{figure}
