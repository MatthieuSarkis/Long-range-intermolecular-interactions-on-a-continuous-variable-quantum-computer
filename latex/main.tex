...
\textcolor{purple}{
    \begin{itemize}
        \item  add plot for small angle and tunnel effect
    \end{itemize}
}
...
\paragraph*{Photonic circuit and Variational Algorithm}
    ...
    \label{fig:quantum_circuit}
        ...
        \end{equation*}
        \caption{One layer in the optical quantum circuit. The various parameterized gates, namely the beamsplitters, rotation, squeezing, displacement and Kerr gates are collectively parameterized by $\omega$.}
    \end{figure}
