...
\paragraph*{Ground state wavefunction and entanglement entropy}
    ...
    \begin{figure}
        ...
        %\end{subfigure}
    \caption{\label{fig:entropy_correlation}\textbf{On the top.} Entanglement entropy vs. interatomic distance. \textbf{On the bottom.} Position quadratures correlation coefficient vs. interatomic distance. Both curves correspond to the model at angle $\theta=0.58$.}
    \end{figure}
